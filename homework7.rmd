...
(-2) See comment at the end of Q1.
...
(-4 total) I'm not entirely sure what you did, but it looks like you added too many observations for each id. Your visit counts are higher than they should be, for instance, id:15 should only have visited 8 times. Your visit #4 is only 5 days after the time before it, so you might be adding things too early. Feel free to ask me questions about this!
