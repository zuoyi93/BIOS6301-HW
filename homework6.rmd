...
#40/40, Great job! Love the orange too. - cole h.
...
ffvalues <- function(path, file='outfile.csv', nTeams=12, cap=200, posReq=c(qb=1, rb=2, wr=3, te=1, k=1),
  ...
  ## read in CSV files
  k18 <- read.csv("../../2018/proj_k18.csv")
  qb18 <- read.csv("../../2018/proj_qb18.csv")
  rb18 <- read.csv("../../2018/proj_rb18.csv")
  te18 <- read.csv("../../2018/proj_te18.csv")
  wr18 <- read.csv("../../2018/proj_wr18.csv")  
...
haart <- read.csv("../../2018/haart.csv")
haart2 <- read.csv("../../2018/haart2.csv")
